...
function spel() {
    ...
    do {
        ...
        Poängställning: ${pointsComputer} (dator) / ${pointsPlayer} (du).`).toLowerCase();
            ...
            else if ((nummer == 'sten' && usersChoice == 'sax') || (nummer == 'sax' && usersChoice == 'påse') || (nummer == 'påse' && usersChoice == 'sten')) {
                pointsComputer++;
                // if (counter < 3) {
            ...
            else if ((nummer == 'sten' && usersChoice == 'påse') || (nummer == 'sax' && usersChoice == 'sten') || (nummer == 'påse' &&  usersChoice == 'sax')) {
                pointsPlayer++;
                // if (counter < 3) {
